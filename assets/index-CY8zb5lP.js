(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var Um={exports:{}},kl={},Om={exports:{}},We={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(O,q){var te=O.length;O.push(q);e:for(;0<te;){var re=te-1>>>1,ee=O[re];if(0<r(ee,q))O[re]=q,O[te]=ee,te=re;else break e}}function n(O){return O.length===0?null:O[0]}function i(O){if(O.length===0)return null;var q=O[0],te=O.pop();if(te!==q){O[0]=te;e:for(var re=0,ee=O.length,Ue=ee>>>1;re<Ue;){var je=2*(re+1)-1,Pe=O[je],Q=je+1,le=O[Q];if(0>r(Pe,te))Q<ee&&0>r(le,Pe)?(O[re]=le,O[Q]=te,re=Q):(O[re]=Pe,O[je]=te,re=je);else if(Q<ee&&0>r(le,te))O[re]=le,O[Q]=te,re=Q;else break e}}return q}function r(O,q){var te=O.sortIndex-q.sortIndex;return te!==0?te:O.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],u=[],h=1,p=null,d=3,m=!1,x=!1,T=!1,v=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,y=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function M(O){for(var q=n(u);q!==null;){if(q.callback===null)i(u);else if(q.startTime<=O)i(u),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(u)}}function S(O){if(T=!1,M(O),!x)if(n(l)!==null)x=!0,Z(A);else{var q=n(u);q!==null&&W(S,q.startTime-O)}}function A(O,q){x=!1,T&&(T=!1,f(_),_=-1),m=!0;var te=d;try{for(M(q),p=n(l);p!==null&&(!(p.expirationTime>q)||O&&!N());){var re=p.callback;if(typeof re=="function"){p.callback=null,d=p.priorityLevel;var ee=re(p.expirationTime<=q);q=t.unstable_now(),typeof ee=="function"?p.callback=ee:p===n(l)&&i(l),M(q)}else i(l);p=n(l)}if(p!==null)var Ue=!0;else{var je=n(u);je!==null&&W(S,je.startTime-q),Ue=!1}return Ue}finally{p=null,d=te,m=!1}}var w=!1,C=null,_=-1,b=5,P=-1;function N(){return!(t.unstable_now()-P<b)}function U(){if(C!==null){var O=t.unstable_now();P=O;var q=!0;try{q=C(!0,O)}finally{q?X():(w=!1,C=null)}}else w=!1}var X;if(typeof y=="function")X=function(){y(U)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,k=K.port2;K.port1.onmessage=U,X=function(){k.postMessage(null)}}else X=function(){v(U,0)};function Z(O){C=O,w||(w=!0,X())}function W(O,q){_=v(function(){O(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){x||m||(x=!0,Z(A))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(O){switch(d){case 1:case 2:case 3:var q=3;break;default:q=d}var te=d;d=q;try{return O()}finally{d=te}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,q){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var te=d;d=O;try{return q()}finally{d=te}},t.unstable_scheduleCallback=function(O,q,te){var re=t.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?re+te:re):te=re,O){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=te+ee,O={id:h++,callback:q,priorityLevel:O,startTime:te,expirationTime:ee,sortIndex:-1},te>re?(O.sortIndex=te,e(u,O),n(l)===null&&O===n(u)&&(T?(f(_),_=-1):T=!0,W(S,te-re))):(O.sortIndex=ee,e(l,O),x||m||(x=!0,Z(A))),O},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(O){var q=d;return function(){var te=d;d=q;try{return O.apply(this,arguments)}finally{d=te}}}})(Ym);qm.exports=Ym;var ux=qm.exports;/**
 * @license React
...
`)+`
`+f);const M=y+v+a,S=y+f+o,A=Tm(r,r.VERTEX_SHADER,M),w=Tm(r,r.FRAGMENT_SHADER,S);r.attachShader(T,A),r.attachShader(T,w),n.index0AttributeName!==void 0?r.bindAttribLocation(T,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(T,0,"position"),r.linkProgram(T);function C(N){if(t.debug.checkShaderErrors){const U=r.getProgramInfoLog(T)||"",X=r.getShaderInfoLog(A)||"",K=r.getShaderInfoLog(w)||"",k=U.trim(),Z=X.trim(),W=K.trim();let O=!0,q=!0;if(r.getProgramParameter(T,r.LINK_STATUS)===!1)if(O=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,T,A,w);else{const te=Am(r,A,"vertex"),re=Am(r,w,"fragment");Qe("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(T,r.VALIDATE_STATUS)+`
