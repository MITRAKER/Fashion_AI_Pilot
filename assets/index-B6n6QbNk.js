 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(O,q){var te=O.length;O.push(q);e:for(;0<te;){var Y=te-1>>>1,ce=O[Y];if(0<r(ce,q))O[Y]=q,O[te]=ce,te=Y;else break e}}function n(O){return O.length===0?null:O[0]}function i(O){if(O.length===0)return null;var q=O[0],te=O.pop();if(te!==q){O[0]=te;e:for(var Y=0,ce=O.length,Fe=ce>>>1;Y<Fe;){var Ie=2*(Y+1)-1,Ge=O[Ie],Z=Ie+1,oe=O[Z];if(0>r(Ge,te))Z<ce&&0>r(oe,Ge)?(O[Y]=oe,O[Z]=te,Y=Z):(O[Y]=Ge,O[Ie]=te,Y=Ie);else if(Z<ce&&0>r(oe,te))O[Y]=oe,O[Z]=te,Y=Z;else break e}}return q}function r(O,q){var te=O.sortIndex-q.sortIndex;return te!==0?te:O.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],u=[],h=1,p=null,d=3,m=!1,x=!1,T=!1,v=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,y=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function M(O){for(var q=n(u);q!==null;){if(q.callback===null)i(u);else if(q.startTime<=O)i(u),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(u)}}function S(O){if(T=!1,M(O),!x)if(n(l)!==null)x=!0,K(b);else{var q=n(u);q!==null&&G(S,q.startTime-O)}}function b(O,q){x=!1,T&&(T=!1,f(_),_=-1),m=!0;var te=d;try{for(M(q),p=n(l);p!==null&&(!(p.expirationTime>q)||O&&!N());){var Y=p.callback;if(typeof Y=="function"){p.callback=null,d=p.priorityLevel;var ce=Y(p.expirationTime<=q);q=t.unstable_now(),typeof ce=="function"?p.callback=ce:p===n(l)&&i(l),M(q)}else i(l);p=n(l)}if(p!==null)var Fe=!0;else{var Ie=n(u);Ie!==null&&G(S,Ie.startTime-q),Fe=!1}return Fe}finally{p=null,d=te,m=!1}}var w=!1,R=null,_=-1,C=5,P=-1;function N(){return!(t.unstable_now()-P<C)}function I(){if(R!==null){var O=t.unstable_now();P=O;var q=!0;try{q=R(!0,O)}finally{q?X():(w=!1,R=null)}}else w=!1}var X;if(typeof y=="function")X=function(){y(I)};else if(typeof MessageChannel<"u"){var Q=new MessageChannel,B=Q.port2;Q.port1.onmessage=I,X=function(){B.postMessage(null)}}else X=function(){v(I,0)};function K(O){R=O,w||(w=!0,X())}function G(O,q){_=v(function(){O(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){x||m||(x=!0,K(b))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):C=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(O){switch(d){case 1:case 2:case 3:var q=3;break;default:q=d}var te=d;d=q;try{return O()}finally{d=te}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,q){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var te=d;d=O;try{return q()}finally{d=te}},t.unstable_scheduleCallback=function(O,q,te){var Y=t.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?Y+te:Y):te=Y,O){case 1:var ce=-1;break;case 2:ce=250;break;case 5:ce=1073741823;break;case 4:ce=1e4;break;default:ce=5e3}return ce=te+ce,O={id:h++,callback:q,priorityLevel:O,startTime:te,expirationTime:ce,sortIndex:-1},te>Y?(O.sortIndex=te,e(u,O),n(l)===null&&O===n(u)&&(T?(f(_),_=-1):T=!0,G(S,te-Y))):(O.sortIndex=ce,e(l,O),x||m||(x=!0,K(b))),O},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(O){var q=d;return function(){var te=d;d=q;try{return O.apply(this,arguments)}finally{d=te}}}})(Ym);qm.exports=Ym;var ux=qm.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ni,depthTest:!1,depthWrite:!1})}function qE(t,e,n){const i=new Float32Array(Cr),r=new z(0,1,0);return new vi({name:"SphericalGaussianBlur",defines:{n:Cr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:tc(),fragmentShader:`
